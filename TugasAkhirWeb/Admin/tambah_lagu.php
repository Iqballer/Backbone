...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $query = "INSERT INTO musik (judul, id_provinsi, daerah, deskripsi, lirik, foto) VALUES ('$judul', '$id_provinsi', '$daerah', '$deskripsi', '$lirik', '$foto')";
            ...
            <section class="admin-section">
                ...
                <form method="POST" action="" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select id="id_provinsi" name="id_provinsi" required>
                                    ...
                                    while ($provinsi = mysqli_fetch_assoc($result)) {
                                        echo "<option value='{$provinsi['id_provinsi']}'>{$provinsi['nama']}</option>";
                                    }
                                    ?>
                                </select>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input id="deskripsi" name="deskripsi" required></input>
                            </div>

                            <div class="form-group">
                                <label for="lirik">Lirik</label>
                                <input id="lirik" name="lirik" required></input>
                            </div>

                            <div class="form-group">
                                <label class="upload-label" for="foto">
                                    Pilih Foto
                            ...
                            <button type="submit" class="admin-submit">Tambah</button>
                        </form>
                </div>
            </section>
        </main>
