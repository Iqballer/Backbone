...
$query = "SELECT * FROM quiz ORDER BY id_quiz ASC LIMIT $start_from, $limit";
...
<div class="sidebar">
    ...
    <div class="container">
        ...
        <div class="container-tambah">
            <input type="text" placeholder="Cari Quiz" class="search-bar">
                ...
                <?php while ($row = mysqli_fetch_assoc($result)) { ?>
                    <tr>
                        ...
                        <td class="action-btns">
                            <a href="lihat_lagu.php?id=<?php echo $row['id_musik']; ?>" class="btn-view">🔍</a>
                            <a href="edit_lagu.php?id=<?php echo $row['id_musik']; ?>" class="btn-edit">✏️</a>
                            <a href="delete_lagu.php?id=<?php echo $row['id_musik']; ?>" class="btn-delete" onclick="return confirm('Anda yakin ingin menghapus lagu ini?');">🗑️</a>
                        </td>
                    </tr>
                <?php } ?>
            </tbody>
        ...
        <?php
        // Pagination
        $query = "SELECT COUNT(id_quiz) FROM quiz";
        $result = mysqli_query($conn, $query);
