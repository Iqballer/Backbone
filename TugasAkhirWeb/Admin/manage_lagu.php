...
$query = "SELECT musik.id_musik, musik.judul, provinsi.nama AS provinsi, musik.daerah, LEFT(musik.deskripsi, 100) AS deskripsi
          FROM musik
          LEFT JOIN provinsi ON musik.id_provinsi = provinsi.id_provinsi
          ORDER BY musik.id_musik ASC
...
<body>
    ...
    <div class="container">
        ...
        <div class="container-tambah">
            <input type="text" placeholder="Cari Lagu" class="search-bar">
            <a href="tambah_lagu.php" ><svg xmlns="http://www.w3.org/2000/svg" height="35px" viewBox="0 -960 960 960" width="35px" fill="#00000"><path d="M560-320h80v-80h80v-80h-80v-80h-80v80h-80v80h80v80ZM160-160q-33 0-56.5-23.5T80-240v-480q0-33 23.5-56.5T160-800h240l80 80h320q33 0 56.5 23.5T880-640v400q0 33-23.5 56.5T800-160H160Zm0-80h640v-400H447l-80-80H160v480Zm0 0v-480 480Z"/></svg></a>
        </div>
        ...
        <?php
        // Pagination
        $query = "SELECT COUNT(id_musik) FROM musik";
        $result = mysqli_query($conn, $query);
        ...
        <nav class="pagination-nav">
            <ul class="pagination">
                <?php for ($i = 1; $i <= $total_pages; $i++) { ?>
                    <li><a href="manage_lagu.php?page=<?php echo $i; ?>" class="<?php if ($page == $i) echo 'active'; ?>"><?php echo $i; ?></a></li>
                <?php } ?>
            </ul>
        </nav>
    </div>
